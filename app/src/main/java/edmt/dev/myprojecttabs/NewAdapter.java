...
import static edmt.dev.myprojecttabs.R.layout.second_item;
...
public class NewAdapter extends ArrayAdapter<String> {
    ...
    public NewAdapter(Context context, String[] name, int[] images, String[] urls) {
        super(context, R.layout.second_item, R.id.textView1, name);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(singleItem == null){
            ...
            singleItem = layoutInflater.inflate(second_item,parent,false);
